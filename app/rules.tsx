    ...
    <SafeAreaView style={styles.container} edges={['top', 'bottom']}>
      ...
      >
        ...
        <View style={styles.header}>
          ...
          <ThemedText style={styles.headerTitle}>قوانین و مقررات</ThemedText>
          <View style={styles.headerSpacer} />
        </View>

        {/* Content */}
        <View style={styles.content}>
          <ThemedText style={styles.title}>قوانین و مقررات</ThemedText>
          <ThemedText style={styles.description}>
            توضیحات قوانین و مقررات در این قسمت نوشته میشود
          </ThemedText>
        </View>
      </ScrollView>
